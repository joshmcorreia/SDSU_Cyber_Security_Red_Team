...
class ChallengeSevenRXSS(Exploit):
	...
	def run_command(self, command):
		raise UnsupportedException(f"Running commands with ChallengeSevenRXSS is not supported.")

	def run_hellevator(self):
		raise UnsupportedException(f"Running Hellevator with ChallengeSevenRXSS is not supported.")
